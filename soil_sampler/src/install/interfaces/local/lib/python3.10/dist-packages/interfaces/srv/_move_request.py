...
class Metaclass_MoveRequest(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from interfaces.srv import _move_request
...
class MoveRequest(metaclass=Metaclass_MoveRequest):
    from interfaces.srv._move_request import MoveRequest_Request as Request
    from interfaces.srv._move_request import MoveRequest_Response as Response
