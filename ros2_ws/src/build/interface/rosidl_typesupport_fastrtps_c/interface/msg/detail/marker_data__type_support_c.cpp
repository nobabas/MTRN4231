...
#include "interface/msg/detail/marker_data__rosidl_typesupport_fastrtps_c.h"
...
using _MarkerData__ros_msg_type = interface__msg__MarkerData;
...
size_t get_serialized_size_interface__msg__MarkerData(
  const void * untyped_ros_message,
...
static uint32_t _MarkerData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interface__msg__MarkerData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interface
size_t max_serialized_size_interface__msg__MarkerData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _MarkerData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interface__msg__MarkerData(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interface, msg, MarkerData)() {
