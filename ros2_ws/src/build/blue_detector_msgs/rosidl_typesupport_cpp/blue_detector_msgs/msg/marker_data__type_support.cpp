...
static const _MarkerData_type_support_symbol_names_t _MarkerData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, blue_detector_msgs, msg, MarkerData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, blue_detector_msgs, msg, MarkerData)),
  }
};
...
{
  return &::blue_detector_msgs::msg::rosidl_typesupport_cpp::MarkerData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, blue_detector_msgs, msg, MarkerData)() {
  return get_message_type_support_handle<blue_detector_msgs::msg::MarkerData>();
}
