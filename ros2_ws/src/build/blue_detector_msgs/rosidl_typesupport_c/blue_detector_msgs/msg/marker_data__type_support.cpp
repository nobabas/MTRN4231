...
static const _MarkerData_type_support_symbol_names_t _MarkerData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, blue_detector_msgs, msg, MarkerData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, blue_detector_msgs, msg, MarkerData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, blue_detector_msgs, msg, MarkerData)() {
  return &::blue_detector_msgs::msg::rosidl_typesupport_c::MarkerData_message_type_support_handle;
}
